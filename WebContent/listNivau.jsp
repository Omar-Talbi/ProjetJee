...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <button type="button" class="btn btn-primary addBtn" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"> <i class ="fa fa-plus"></i> Ajouter un niveau</button>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="libelle" name="libelle" placeholder="Nom niveau">
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">Niveau</label>
                                    <input type="text" class="form-control" id="nlibelle" name="libelle" placeholder="Nom niveau">
                                </div>
                            </div>
                        </div>
                    </form>
