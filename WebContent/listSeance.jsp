...
<div class="container-fluid">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" style="text-align: center;font-size: 25px;">Modifier la Seance</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select  class="form-control" id="smatiere" name="matiere" >
                                            <option disabled selected > Modifier la Matiére </option>
                                            <% for (Matiere matiere : listMat) { %>
                                            <option value="<% out.print(matiere.getId());%>" > <% out.print(matiere.getLibelle());%></option>
                                            <% }%>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="closebtn" data-dismiss="modal">Fermer</button>
                    <button type="button" class="btn btn-primary" id="updateSc" >Modifier la  Seance</button>
                </div>
            </div>
        </div>
    </div>
